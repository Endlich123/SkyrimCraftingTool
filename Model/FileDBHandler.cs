...
namespace SkyrimCraftingTool.Model
{
    public class FileDBHandler
    {
        ...
        {
            // 1. LoadOrder aus plugins.txt holen
            var loadOrderNames = GetPluginsFromTxt(); // exakt die Reihenfolge wie SSEEdit

            // 2. Aktive Plugins aus DB holen (enthält Pfade)
            var dbPlugins = GetActivePlugins(); // unsortiert

            // 3. Sortieren nach LoadOrder
